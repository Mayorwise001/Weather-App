...
async function getweather(value){
    try{
    const response  = await fetch(`https://api.weatherapi.com/v1/current.json?key=b5263fe229984c9397724957231212&q=${value}`, {mode: 'cors'})
...
fetch(`https://api.weatherapi.com/v1/current.json?key=b5263fe229984c9397724957231212&q=nigeria`, {mode: 'cors'})
